...
gulp.task('watch', function() {
    ...
    gulp.watch("docs/fonts/**/*").on('add', gulp.parallel('fonts'));
    gulp.watch("docs/icons/**/*").on('add', gulp.parallel('icons'));
    gulp.watch("docs/img/**/*").on('add', gulp.parallel('images'));
});
...
gulp.task('icons', function () {
    return gulp.src("docs/icons/**/*")
        .pipe(gulp.dest("docs/dist/icons"))
        .pipe(browserSync.stream());
});
